...
class TestFeatureExtraction(unittest.TestCase):
    ...
    def test_get_is_always_recurring(self):
        ...
        self.assertFalse(get_is_always_recurring(Transaction(id=11, user_id="user1", name="McDonald's", amount=5.99, date="2024-01-10")))

    def test_get_is_insurance(self):
        self.assertTrue(get_is_insurance(Transaction(id=12, user_id="user1", name="Auto Insurance Payment", amount=120.0, date="2024-01-15")))
        self.assertFalse(get_is_insurance(Transaction(id=13, user_id="user1", name="Gas Station", amount=40.0, date="2024-01-12")))

    def test_get_is_utility(self):
        self.assertTrue(get_is_utility(Transaction(id=14, user_id="user1", name="Electric Utility Bill", amount=75.0, date="2024-01-25")))
        self.assertFalse(get_is_utility(Transaction(id=15, user_id="user1", name="Restaurant", amount=30.0, date="2024-02-01")))

    def test_get_is_phone(self):
        self.assertTrue(get_is_phone(Transaction(id=16, user_id="user1", name="T-Mobile Monthly Plan", amount=50.0, date="2024-02-15")))
        self.assertFalse(get_is_phone(Transaction(id=17, user_id="user1", name="Water Utility Bill", amount=60.0, date="2024-03-01")))
    ...
    def test_get_ends_in_99(self):
        self.assertTrue(get_ends_in_99(Transaction(id=18, user_id="user1", name="Subscription", amount=15.99, date="2024-01-01")))
        self.assertFalse(get_ends_in_99(Transaction(id=19, user_id="user1", name="Store Purchase", amount=20.00, date="2024-01-01")))
...
def test_get_is_common_subscription_amount(self):
    self.assertTrue(get_is_common_subscription_amount(Transaction(id=20, user_id="user1", name="Hulu", amount=9.99, date="2024-01-01")))
    self.assertFalse(get_is_common_subscription_amount(Transaction(id=21, user_id="user1", name="Store Purchase", amount=27.50, date="2024-01-15")))

def test_get_occurs_same_week(self):
    user_transactions = self.get_user_transactions(self.transactions, "user1")
    self.assertTrue(get_occurs_same_week(Transaction(id=22, user_id="user1", name="Netflix", amount=15.99, date="2024-03-01"), user_transactions))
    self.assertFalse(get_occurs_same_week(Transaction(id=23, user_id="user1", name="One-time Purchase", amount=99.99, date="2024-01-20"), user_transactions))

def test_get_is_similar_name(self):
    user_transactions = self.get_user_transactions(self.transactions, "user1")
    self.assertTrue(get_is_similar_name(Transaction(id=24, user_id="user1", name="Spotify Premium", amount=9.99, date="2024-02-01"), user_transactions))
    self.assertFalse(get_is_similar_name(Transaction(id=25, user_id="user1", name="Amazon Purchase", amount=50.00, date="2024-03-05"), user_transactions))

def test_get_is_fixed_interval(self):
    user_transactions = self.get_user_transactions(self.transactions, "user1")
    self.assertTrue(get_is_fixed_interval(Transaction(id=26, user_id="user1", name="Netflix", amount=15.99, date="2024-03-01"), user_transactions))
    self.assertFalse(get_is_fixed_interval(Transaction(id=27, user_id="user1", name="Gas Station", amount=40.00, date="2024-02-10"), user_transactions))

def test_get_has_irregular_spike(self):
    user_transactions = self.get_user_transactions(self.transactions, "user1")
    self.assertTrue(get_has_irregular_spike(Transaction(id=28, user_id="user1", name="Internet Bill", amount=100.00, date="2024-03-01"), user_transactions))
    self.assertFalse(get_has_irregular_spike(Transaction(id=29, user_id="user1", name="Spotify", amount=9.99, date="2024-02-01"), user_transactions))

def test_get_is_first_of_month(self):
    self.assertTrue(get_is_first_of_month(Transaction(id=30, user_id="user1", name="Rent Payment", amount=1200.00, date="2024-02-01")))
    self.assertFalse(get_is_first_of_month(Transaction(id=31, user_id="user1", name="Grocery", amount=75.00, date="2024-02-15")))
